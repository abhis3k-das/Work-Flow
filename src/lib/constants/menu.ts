...
export const SIDEBAR_ITEMS : MenuType[] = [
...

  {
    ...
    items: [
      ...
      { title: "API Keys / Integrations", url: "/settings/integrations", icon: Key },
      { title: "Access Control", url: "/settings/access-control", icon: Shield },
      { title: "SMTP Settings", url: "/settings/smtp", icon: Mail },
      { title: "Storage Settings", url: "/settings/storage", icon: Database },
      { title: "Security (2FA, IP Restriction)", url: "/settings/security", icon: Lock },
    ],
  },
];
